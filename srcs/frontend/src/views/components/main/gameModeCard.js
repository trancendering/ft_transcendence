...
import Single from "../../../static/img/single-game-mode.svg";
import Tournament from "../../../static/img/tournament-game-mode.svg";
    ...
    async render() {
        ...
        const view = `
            <div class="d-flex flex-column align-items-center justify-content-center p-3 m-3">
                <img class="mb-3" width="60" height="60" src="${gameModeSvgPaths[this.gameMode]}" alt="${this.id}">
