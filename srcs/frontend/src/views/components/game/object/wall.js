...
eastWall.position.set((tableWidth + sideMargin) / 2 + verticalWallWidth / 2, 0, verticalWallDepth / 2);
westWall.position.set(-(tableWidth + sideMargin) / 2 - verticalWallWidth / 2, 0, verticalWallDepth / 2);
